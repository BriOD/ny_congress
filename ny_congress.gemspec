...
require 'ny_congress/version'

Gem::Specification.new do |spec|
  spec.name          = "ny_congress"
  spec.version       = NyCongress::VERSION
  spec.authors       = ["BriOD"]
  spec.email         = ["briodonoghue@gmail.com"]
  ...
  spec.homepage      = "A: Put your gem's website or public repo URL here."
  spec.license       = "MIT"
